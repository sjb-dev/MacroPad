...
static const char *keycode_label_basic(uint16_t kc) {
    switch (kc) {
        ...
        // Mouse buttons + wheel
        case KC_BTN1:         return "Btn1";
        case KC_BTN2:         return "Btn2";
        case KC_BTN3:         return "Btn3";
        case KC_BTN4:         return "Btn4";
        case KC_BTN5:         return "Btn5";
        case KC_WH_U:         return "WhUp";
        case KC_WH_D:         return "WhDn";
        case KC_WH_L:         return "WhL";
        case KC_WH_R:         return "WhR";
        case KC_MS_U:         return "MsUp";
        case KC_MS_D:         return "MsDn";
        case KC_MS_L:         return "MsL";
        case KC_MS_R:         return "MsR";
